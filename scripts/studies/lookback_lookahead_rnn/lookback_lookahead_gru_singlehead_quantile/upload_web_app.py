...
``lookback_lookahead_gru_singlehead_quantile/app``):

    gs://payamdpycryptoreports/lookback_lookahead_gru_singlehead_quantile/app/index.html
    gs://payamdpycryptoreports/lookback_lookahead_gru_singlehead_quantile/app/css/styles.css
    gs://payamdpycryptoreports/lookback_lookahead_gru_singlehead_quantile/app/js/config.js
    ...
...
OBSERVATION_SET_NAME = "lookback_lookahead_gru_singlehead_quantile"
