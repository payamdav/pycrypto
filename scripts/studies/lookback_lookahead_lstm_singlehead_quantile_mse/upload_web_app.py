...
``lookback_lookahead_lstm_singlehead_quantile_mse/app``):

    gs://payamdpycryptoreports/lookback_lookahead_lstm_singlehead_quantile_mse/app/index.html
    gs://payamdpycryptoreports/lookback_lookahead_lstm_singlehead_quantile_mse/app/css/styles.css
    gs://payamdpycryptoreports/lookback_lookahead_lstm_singlehead_quantile_mse/app/js/config.js
    ...
