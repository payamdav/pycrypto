...
Resulting layout (with the default prefix ``lookback_lookahead_mlp_mse/app``):

    gs://payamdpycryptoreports/lookback_lookahead_mlp_mse/app/index.html
    gs://payamdpycryptoreports/lookback_lookahead_mlp_mse/app/css/styles.css
    gs://payamdpycryptoreports/lookback_lookahead_mlp_mse/app/js/config.js
    ...
