...
Resulting layout (with the default prefix ``lookback_lookahead_mlp_quantile/app``):

    gs://payamdpycryptoreports/lookback_lookahead_mlp_quantile/app/index.html
    gs://payamdpycryptoreports/lookback_lookahead_mlp_quantile/app/css/styles.css
    gs://payamdpycryptoreports/lookback_lookahead_mlp_quantile/app/js/config.js
    ...
