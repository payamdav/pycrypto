...
description: A senior code writer that creates, edits, or deletes files based on instructions delivered through chat, referencing specification files in /ai_chats/. Use when a task needs to be implemented from a spec file.
---
