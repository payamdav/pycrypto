---
name: code_tester
description: Creates visual, human-verifiable test notebooks for specific parts of the program, placing them under /notebooks/tests/ in Jupyter notebook format.
---
